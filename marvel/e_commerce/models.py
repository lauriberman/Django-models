...
class Wish_list(models.Model):
    ...
    comic_id = models.ForeignKey(Comic,
        verbose_name="Comic",on_delete=models.DO_NOTHING,
        default=1, blank=True)
    favorite = models.BooleanField(
        verbose_name='Favorites', default='')
    cart = models.BooleanField(
        verbose_name="Cart", default='')
    wished_qty = models.PositiveBigIntegerField(
        verbose_name="Wished Qty", default=0)
    buied_qty = models.PositiveBigIntegerField(
        verbose_name="Buied Qty", default=0)

    class Meta:
    #Atributos de nuestras entidades como nombre de la tabla. 
